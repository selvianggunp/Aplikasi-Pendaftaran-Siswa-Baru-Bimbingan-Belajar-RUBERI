...
class Pimpinan extends CI_Controller
{
	...
	public function data_jenis_pendaftaran(){
		...
		$this->load->view('pimpinan/data_jenis_pendaftaran', $data);
	}
	...
	public function data_jenis_SPP(){
		...
		$this->load->view('pimpinan/data_jenis_SPP', $data);
	}
	...
	public function data_siswa(){
		...
		$this->load->view('pimpinan/data_siswa', $data);
	}
	...
	public function data_transaksi_pendaftaran(){
		...
		$this->load->view('pimpinan/data_transaksi_pendaftaran', $data);
	}
	...
	public function transaksi_pendaftaran($kd){
		...
		$this->load->view('pimpinan/transaksi_pendaftaran', $data);
		...
		if (isset($_POST['submit'])) {
			...
			redirect('pimpinan/data_transaksi_pendaftaran');
		} 
	}
	...
	public function detail_transaksi_pendaftaran($id){
		...
		$this->load->view('pimpinan/detail_transaksi_pendaftaran', $data);
	}
	...
	$kd_user = $this->session->userdata('kd_user');
		...
		$this->load->view('pimpinan/tambah_dtspp_pks', $data);
	}
	...
	public function data_transaksi_SPP(){
		...
		$this->load->view('pimpinan/data_transaksi_spp', $data);
	}
	...
	$kd_user = $this->session->userdata('kd_user');
		...
		$this->load->view('pimpinan/detail_transaksi_spp', $data);
	}
	...
	public function total_jumlah_siswa(){
		...
		$this->load->view('pimpinan/total_jumlah_siswa', $data);
	}
	...
	public function jumlah_siswa_sd(){
		...
		$this->load->view('pimpinan/jumlah_siswa_sd', $data);
	}
	...
	public function jumlah_siswa_smp(){
		...
		$this->load->view('pimpinan/jumlah_siswa_smp', $data);
	}
	...
	public function jumlah_siswa_sma(){
		...
		$this->load->view('pimpinan/jumlah_siswa_sma', $data);
	}
	...
	public function edit_akun($id){
		...
		$this->load->view('pimpinan/edit_akun', $data);
	...
	public function ganti_password()
	{
		...
		if ($this->form_validation->run() ==  false) {
			...
			$this->load->view('pimpinan/ganti_password', $data);
		}else{
			...
			redirect('pimpinan/ganti_password'); 
			} else {
