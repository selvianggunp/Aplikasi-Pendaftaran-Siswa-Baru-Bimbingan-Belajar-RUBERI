      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-light bg-light" >
           <h6 class="m-0 font-weight-bold">Info Pembayaran SPP</h6>
            ...
            <tr>
              ...
              <th width="20px">Kode Transaksi</th>
              <th width="20px">Nominal</th>
              <th width="20px">Bulan</th>
              <th width="20px">Tanggal Bayar</th>
          ...
          <?php $no = 0; foreach ($data_transaksi_spp as $dts) { ?>
            <tr>
                ...
                <td>Rp. <?= number_format($dts['biaya'], 0, ',', '.'); ?></td>
                <td><?= $dts['bulan']; ?></td>
                <td><?php $tgl = date_create($dts['tgl_bayar']); echo date_format($tgl, 'd-m-Y');?></td>
                <td class="text-center">
                   <a href="<?= base_url();?>user/detail_transaksi_spp/<?= $dts['kd_transaksi_spp']; ?>" class="btn btn-info btn-circle btn-sm "><i class="fas fa-align-justify"></i></a> 
                </td>
