              ...
              <div class="row mt-3">
                <div class="col-md">
                  <div class="card">
                    ...
                    <div class="card-body">
                     <form action="<?= base_url('user/transaksi_spp'); ?>" method="POST" enctype="multipart/form-data">
                     <!------------------------- PEMBAYARAN ------------------------>
                    <div class="form-group">
                      ...
                      <div class="form-row">
                       ...
                       <div class="form-row">
                        <div class="form-group col-md-4">
                          <label for="pemilik_rek">Pemilik Rekening</label><br>
                           <input type="text" name="pemilik_rek" id="pemilik_rek" class="form-control form-control-user" required="">
                        </div>
                        <div class="form-group col-md-4">
                          <label for="no_rek">No Rekening</label><br>
                          <input type="text" name="no_rek" id="no_rek" class="form-control form-control-user" onkeypress="return event.charCode >= 48 && event.charCode <=57" required="">
                        </div>
                        <div class="form-group col-md-4">
                          <label for="file_transfer">Upload Bukti Transfer</label><br>
                          <input type="file" class="form-control form-control-user" name="file_transfer" id="file_transfer" required="">
                          <p class="text-info">
                      ...
                      <button type="submit" class="btn btn-primary btn-user btn-block">BAYAR SPP</button>
                     </form>
                    </div>
                  </div>
                </div>
