              ...
              <div class="row mt-3">
                ...
                <div class="col-md-8">
                  <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('user/edit_data_diri'); ?>" method="POST">
                       <div class="text-center"><img width="70" src="<?= base_url('assets/photo/') . $siswa['photo'];  ?> "></div><br>
                      <table class="table">
                       
                      <tr>
                        <td>kode siswa</td>
                        <td>: <?= $siswa['kd_siswa']; ?></td>
                      </tr>
                      <tr>
                        <td>Nama Lengkap</td>
                      ...
                      <tr>
                        <td>Tanggal Lahir</td>
                        <td>: <?php $tgl = date_create($siswa['tgl_lahir']); echo date_format($tgl, 'd-m-Y');  ?></td>
                      </tr>
                      <tr>
                        <td>Agama</td>
                        <td>: <?= $siswa['agama']; ?></td>
                      ...
                      <tr>
                        ...
                        <td>
                          <button type="submit" name="submit" class="btn btn-primary btn-user btn-block">EDIT DATA DIRI</button>
                        </td>
                        <td></td>
                      </tr>
                  </table>
