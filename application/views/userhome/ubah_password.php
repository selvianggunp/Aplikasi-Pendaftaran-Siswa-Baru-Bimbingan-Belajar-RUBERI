                   ...
                   <form action="" method="POST">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="password" class="form-control form-control-user" name="konfirmasi_password" id="konfirmasi_password" > 
                      <?= form_error('konfirmasi_password', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    
                      <button type="submit" name="submit" class="btn btn-primary btn-user btn-block">GANTI PASSWORD </button>
                   </form>
                  </div>
                </div>
              </div>
