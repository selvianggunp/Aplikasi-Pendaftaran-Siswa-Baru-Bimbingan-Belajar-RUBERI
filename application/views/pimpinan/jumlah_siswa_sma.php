                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-black text-uppercase mb-1">
                        <a href="<?= base_url('pimpinan/total_jumlah_siswa'); ?>">Total jumlah siswa</a>
                      </div>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                        <a href="<?= base_url('pimpinan/jumlah_siswa_sd'); ?>">Jumlah Siswa SD</a>
                      </div>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                        <a href="<?= base_url('pimpinan/jumlah_siswa_smp'); ?>">
                        Jumlah Siswa SMP
                        </a>
                      </div>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                        <a href="<?= base_url('pimpinan/jumlah_siswa_sma'); ?>">
                          Jumlah Siswa SMA
                        </a>
                      </div>
