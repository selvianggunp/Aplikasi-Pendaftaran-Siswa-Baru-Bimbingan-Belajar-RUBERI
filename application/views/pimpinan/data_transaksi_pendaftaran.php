            ...
            <?php $no=0; foreach ($data_transaksi_pendaftaran as $dtp) { ?>
              <tr>
                  ...
                  <td class="text-center">
                      <a href="<?= base_url();?>pimpinan/detail_transaksi_pendaftaran/<?= $dtp['kd_transaksi_pendaftaran']; ?>" class="btn btn-info btn-circle btn-sm "><i class="fas fa-align-justify"></i></a> 
                  </td>
