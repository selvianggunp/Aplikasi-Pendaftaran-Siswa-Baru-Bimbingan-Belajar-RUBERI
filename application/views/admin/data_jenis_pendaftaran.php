      ...
      <div id="content">
        ...
        <div class="container-fluid">
         ...
         <div class="row-3">
          ...
          <h6 class="m-0 font-weight-bold ">Data Jenis Pendaftaran</h6>
            ...
            <div class="card-body">
             ...
             <tr>
              ...
              <th class="text-center" width="100px">Kode Jenis Pendaftaran</th>
          ...
          <?php $i = 1; foreach ($data_jenis_pendaftaran as $djp) { ?>
            <tr>
                ...
                <td class="text-center"><?= $djp['kd_jenis_pendaftaran']; ?></td>
                <td class="text-center"><?= $djp['jenjang']; ?></td>
                <td class="text-center">Rp. <?= number_format($djp['biaya'], 0, ',', '.'); ?></td>
                <td class="text-center"><a href="<?= base_url(); ?>admin/edit_djp/<?= $djp['kd_jenis_pendaftaran']; ?>" class="btn btn-primary btn-circle btn-sm"><i class="fas fa-edit" ></i></a></td>
            </tr>
            <?php } ?>
          </tbody>
                </table>
