        ...
        <div class="container-fluid">
           ...
           <section>
            <div class="btn-group dropleft">
              <button type="button"class="btn btn-warning btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fas fa-download fa-sm text-white-50"></i>   PDF Laporan  
              </button>
              <div class="dropdown-menu">
                <a target="blank" class="dropdown-item" href="<?= base_url('cetak/pdf_lss'); ?>">PDF Laporan seluruh siswa</a>
                <a target="blank" class="dropdown-item" href="<?= base_url('cetak/pdf_lsbj'); ?>">PDF Laporan berdasarkan jenjang</a>
                <a target="blank" class="dropdown-item" href="<?= base_url('cetak/pdf_lssd'); ?>">PDF Laporan Seluruh Siswa SD</a>
                <a target="blank" class="dropdown-item" href="<?= base_url('cetak/pdf_lssmp'); ?>">PDF Laporan Seluruh Siswa SMP</a>
                <a target="blank" class="dropdown-item" href="<?= base_url('cetak/pdf_lssma'); ?>">PDF Laporan Seluruh Siswa SMA</a>
              </div>
            </div>            
            </section>
            ...
            <tr>
              ...
              <th width="20px">Kode Siswa</th>
              <th width="20px">Kode User</th>
              <th>Nama</th>
          ...
          <?php $no=0; foreach ($data_siswa as $ds) { ?>
            <tr>
                ...
                <td class="text-center"><img width="50" src="<?= base_url('assets/photo/') . $ds['photo'];  ?> "></td>
                <td class="text-center"><?= $ds['kelas']; ?></td>
                <td><?= $ds['sekolah']; ?></td>
                <td class="text-center">
                  <a href="<?= base_url(); ?>admin/edit_siswa/<?= $ds['kd_siswa']; ?>" class="btn btn-primary btn-circle btn-sm"><i class="fas fa-edit" ></i></a>
                  <a href="<?= base_url(); ?>admin/detail_siswa/<?= $ds['kd_siswa']; ?>" class="btn btn-info btn-circle btn-sm"><i class="fas fa-align-justify"></i></a>  
                  <a target="blank" href="<?= base_url(); ?>cetak/kartu_siswa/<?= $ds['kd_siswa']; ?>" class="btn btn-warning btn-circle btn-sm"><i class="far fa-address-card"></i></a>  
                </td>
