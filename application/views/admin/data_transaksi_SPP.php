        ...
        <div class="container-fluid">
         <?= $this->session->flashdata('message'); ?>
          ...
          <nav class="navbar navbar-light bg-light" >
           ...
           <section>
              <a href="<?= base_url('admin/tambah_dtspp_pks'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data Transaksi SPP</a>
          ...
          <?php $no=0; foreach ($data_transaksi_SPP as $dts) { ?>
            <tr>
                ...
                <td class="text-center"><?= $dts['kelas']; ?></td>
                <td><?= $dts['bulan']; ?></td>
                <td><?= $dts['metode_pembayaran']; ?></td>
                <td><?php $tgl = date_create($dts['tgl_bayar']); echo date_format($tgl, 'd-m-Y'); ?></td>
                <td><?= $dts['status']; ?></td>
                <td class="text-center">
                  <a href="<?= base_url();?>admin/transaksi_SPP/<?=  $dts['kd_transaksi_spp']; ?>" class="btn btn-primary btn-circle btn-sm "><i class="fas fa-edit"></i></a> 
                  <a href="<?= base_url(); ?>admin/detail_transaksi_spp/<?= $dts['kd_transaksi_spp']; ?>" class="btn btn-info btn-circle btn-sm"><i class="fas fa-align-justify"></i></a> 
