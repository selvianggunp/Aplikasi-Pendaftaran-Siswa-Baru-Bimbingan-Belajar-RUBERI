                ...
                <div class="card">
                  ...
                  <div class="card-body"> 
                    <div class="text-center">
                      <img width="70" src="<?= base_url('assets/photo/') . $detail_siswa['photo'];  ?> ">
                    </div><br>
                    <table class="table">
                      <tr>
                        <td>Kode Siswa</td>
                        <td>: <?= $detail_siswa['kd_siswa'] ?></td>
                      </tr>
                      <tr>
                        <td>Kode User</td>
                        <td>: <?= $detail_siswa['kd_user'] ?></td>
                      </tr>
                      <tr>
                        <td>Nama Siswa</td>
                        <td>: <?= $detail_siswa['nama_lengkap'] ?></td>
                      </tr>
                      <tr>
                        <td>Jenis Kelamin</td>
                        <td>: <?= $detail_siswa['jenis_kelamin'] ?></td>
                      </tr>
                       <tr>
                        <td>Tanggal Lahir</td>
                        <td>: <?= $detail_siswa['tempat_lahir'] ?>, <?php $tgl = date_create($detail_siswa['tgl_lahir']); echo date_format($tgl, 'd-m-Y'); ?></td>
                      </tr>
                       <tr>
                        <td>Agama</td>
                        <td>: <?= $detail_siswa['agama'] ?></td>
                      </tr>
                       <tr>
                        <td>Jenjang</td>
                        <td>: <?= $detail_siswa['jenjang'] ?></td>
                      </tr>
                       <tr>
                        <td>Kelas</td>
                        <td>: <?= $detail_siswa['kelas'] ?></td>
                      </tr>
                       <tr>
                        <td>Sekolah</td>
                        <td>: <?= $detail_siswa['sekolah'] ?></td>
                      </tr>
                       <tr>
                        <td>Alamat</td>
                        <td>: <?= $detail_siswa['alamat'] ?></td>
                      </tr>
                       <tr>
                        <td>Nama Ayah</td>
                        <td>: <?= $detail_siswa['nama_ayah'] ?></td>
                      </tr>
                       <tr>
                        <td>Telp/Hp Ayah</td>
                        <td>: <?= $detail_siswa['telp_ayah'] ?></td>
                      </tr>
                       <tr>
                        <td>Pekerjaan Ayah</td>
                        <td>: <?= $detail_siswa['pekerjaan_ayah'] ?></td>
                      </tr>
                       <tr>
                        <td>Nama Ibu</td>
                        <td>: <?= $detail_siswa['nama_ibu'] ?></td>
                      </tr>
                       <tr>
                        <td>Telp/Hp Ibu</td>
                        <td>: <?= $detail_siswa['telp_ibu'] ?></td>
                      </tr>
                       <tr>
                        <td>Pekerjaan Ibu</td>
                        <td>: <?= $detail_siswa['pekerjaan_ibu'] ?></td>
                      </tr>
                       <tr>
                        <td>Tanggal Daftar</td>
                        <td>: <?php $tgl = date_create($detail_siswa['tgl_daftar']); echo date_format($tgl, 'd-m-Y'); ?></td>
                      </tr>
                      <tr>
                        <td>
                           <a  class="btn btn-primary" href="<?= base_url('admin/total_jumlah_siswa'); ?>"> <i class="fas fa-caret-left"></i>  Kembali</a>
                        </td>
                        <td></td>
                      </tr>
                    </table>
