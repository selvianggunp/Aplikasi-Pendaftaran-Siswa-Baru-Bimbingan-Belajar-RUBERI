      ...
      <div id="content">
        ...
        <div class="container-fluid">
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-black text-uppercase mb-1">
                        <a href="<?= base_url('admin/total_jumlah_siswa'); ?>">Total jumlah siswa</a>
                      </div>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                        <a href="<?= base_url('admin/jumlah_siswa_sd'); ?>">Jumlah Siswa SD</a>
                      </div>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                        <a href="<?= base_url('admin/jumlah_siswa_smp'); ?>">
                        Jumlah Siswa SMP
                        </a>
                      </div>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                        <a href="<?= base_url('admin/jumlah_siswa_sma'); ?>">
                          Jumlah Siswa SMA
                        </a>
                      </div>
          ...
          <nav class="navbar navbar-light bg-light ">
           <h6 class="m-0 font-weight-bold">Data Siswa SMA</h6>         
          </nav>
          ...
          <?php $no=0; foreach ($data_siswa as $ds) { ?>
           <tr>
                ...
                <td class="text-center">
                  <a href="<?= base_url(); ?>admin/detail_siswa_sma/<?= $ds['kd_siswa']; ?>" class="btn btn-info btn-circle btn-sm"><i class="fas fa-align-justify"></i></a>  
                </td>
            </tr>
            <?php } ?>
          </tbody>
