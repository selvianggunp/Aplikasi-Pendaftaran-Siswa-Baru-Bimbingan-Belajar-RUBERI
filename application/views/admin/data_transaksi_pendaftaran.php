            ...
            <?php $no=0; foreach ($data_transaksi_pendaftaran as $dtp) { ?>
              <tr>
                  ...
                  <td class="text-center">
                    <a href="<?= base_url();?>admin/transaksi_pendaftaran/<?= $dtp['kd_transaksi_pendaftaran']; ?>" class="btn btn-primary btn-circle btn-sm "><i class="fas fa-edit"></i></a> 
                      <a href="<?= base_url();?>admin/detail_transaksi_pendaftaran/<?= $dtp['kd_transaksi_pendaftaran']; ?>" class="btn btn-info btn-circle btn-sm "><i class="fas fa-align-justify"></i></a> 
