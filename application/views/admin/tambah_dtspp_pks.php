      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-light bg-light">
           <h6 class="m-0 font-weight-bold">PILIH DATA SISWA</h6>
          ...
          <?php $no=0; foreach ($data_siswa as $ds) { ?>
            <tr>
                ...
                <td class="text-center"> <?= $ds['jenjang']; ?></td>
                <td><?= $ds['sekolah']; ?></td>
                <td class="text-center">
                  <a href="<?= base_url(); ?>admin/tambah_dtspp/<?= $ds['kd_siswa']; ?>" class="btn btn-primary">PILIH</a>
                </td>
            </tr>
            <?php } ?>
          </tbody>
