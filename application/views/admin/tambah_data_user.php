                  ...
                  <div class="card-body">
                   ...
                   <form action="" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-user" id="kd_user" name="kd_user" value="<?= $newkode; ?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-user" id="password" name="password" value="" required>
                    </div>
                    <div class="form-group">
                      <label for="level">Level</label>
                      <input type="text" class="form-control form-control-user" id="level" name="level" value="" required>
                    </div>
