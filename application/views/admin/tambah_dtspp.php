                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                     ...
                     <div class="form-group">
                        <input type="text" class="form-control form-control-user" name="kd_jenis_spp" id="kd_jenis_spp" size="52" value="<?= $data['kd_jenis_spp']; ?>" readonly hidden>
                      </div>
                      <div class="form-group">
                        <input type="text" class="form-control form-control-user" name="kd_user" id="kd_user" size="52" value="<?= $data['kd_user']; ?>" readonly hidden>
                      </div>

                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="kd_transaksi_spp">kode transaksi SPP</label>
                        <input type="text" class="form-control form-control-user" name="kd_transaksi_spp" id="kd_transaksi_spp" size="52" value="<?= $newkode_trs; ?>" readonly>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-4">
                         <label for="kd_siswa">Kode Siswa</label>
                        <input type="text" class="form-control form-control-user" id="kd_siswa" name="kd_siswa" size="52" value="<?= $data['kd_siswa']; ?>" readonly >
                      </div>
                      <div class="form-group col-md-4">
                        <label for="nama">Nama</label>
                        <input type="text" class="form-control form-control-user" name="nama" size="52" value="<?= $data['nama_lengkap']; ?>" readonly >
                      </div>  
                      <div class="form-group col-md-4">
                        <label for="kelas">Kelas</label>
                        <input type="text" class="form-control form-control-user" name="kelas" size="52" value="<?= $data['kelas']; ?>" readonly >
                      </div>
                    </div>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control form-control-user" name="sekolah" size="52" value="<?= $data['sekolah']; ?>" readonly >
                      </div>
                      <div class="form-group col-md-4">
                        ...
                        <option><?= $bulan[$no]; ?></option>
                        <?php } ?>
                      </select>
                      </div>
                      <div class="form-group col-md-4">
                        <label for="nominal">Jumlah yang harus di bayar</label><br>
                        <input type="text" name="nominal" id="nominal" class="form-control form-control-user" value="Rp. <?= number_format($data['biaya'] , 0, ',', '.'); ?>" readonly>
                      </div>
                    </div>
          
                      <button type="submit" name="submit" class="btn btn-primary btn-user btn-block">BAYAR SPP</button>
                     </form>
                    </div>
                  </div>
                </div>
