        ...
        <div class="card-body">
         ...
         <form action="" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user" name="kd_jenis_spp" value="<?= $data_djspp['kd_jenis_spp'];?>" readonly>
          </div>
          <div class="form-group">
            <label>Jenjang</label>
            <input type="text" class="form-control form-control-user" name="jenjang" value="<?= $data_djspp['jenjang']; ?>" required readonly> 
          </div>
           <div class="form-group">
            <label for="biaya">Biaya</label>
            <input type="text" class="form-control form-control-user" name="biaya" id="biaya" value=" <?= $data_djspp['biaya']; ?>" required onkeypress="return event.charCode >= 48 && event.charCode <=57"> 
          </div>
