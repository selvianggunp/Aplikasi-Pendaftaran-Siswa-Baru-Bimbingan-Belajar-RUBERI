...
<!-- Akun -->
        ...
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-light bg-light ">
           <h6 class="m-0 font-weight-bold">Data Siswa SD</h6>         
          </nav>
          ...
          <?php $no=0; foreach ($data_siswa as $ds) { ?>
           <tr>
                ...
                <td class="text-center">
                  <a href="<?= base_url(); ?>admin/detail_siswa_sd/<?= $ds['kd_siswa']; ?>" class="btn btn-info btn-circle btn-sm"><i class="fas fa-align-justify"></i></a>  
                </td>
            </tr>
            <?php } ?>
          </tbody>
