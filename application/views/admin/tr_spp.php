      ...
      <div id="content">
        ...
        <!-- Content Row -->
          <div class="row-md">
            <form action="" method="POST">
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                   <button type="submit" name="submit" class="btn btn-primary btn-user btn-block">Search</button>
                </div>
              </div>   
            </form>
          ...
          <h6 class="m-0 font-weight-bold ">Data Jenis SPP</h6>
            ...
            <table class="table table-striped table-bordered" border="1" width="100%" cellspacing="0">
            <thead>
            <tr>
          ...
          <tbody>
          <?php $no=0; foreach ($data_spp as $dts) { ?>
            <tr>
