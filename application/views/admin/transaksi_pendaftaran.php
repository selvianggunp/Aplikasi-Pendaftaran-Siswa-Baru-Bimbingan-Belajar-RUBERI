         ...
         <form action="" method="POST">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user" name="biaya"value="Rp. <?= number_format($data_jenis_pendaftaran_bkj['biaya'], 0, ',', '.'); ?>" readonly> 
          </div>
           <div class="form-group">
            <label>Metode Pembayaran</label>
            <input type="text" class="form-control form-control-user" name="biaya" value="<?= $data_transaksi_pendaftaran_bk['metode_pembayaran']; ?>" readonly> 
          </div>
          <div class="form-group">
            <label>Nama Bank</label>
            <input type="text" class="form-control form-control-user" name="nama_bank" value="<?= $data_transaksi_pendaftaran_bk['nama_bank']; ?>" readonly > 
          </div>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user" name="file_transfer" value="<?= $data_transaksi_pendaftaran_bk['file_transfer']; ?>" readonly > 
          </div>
           <div class="form-group">
            <label>Status</label>
