         ...
         <form action="" method="POST">
          ...
          <br> 
            <div class="form-group">
               <label>kode transaksi SPP</label>
            <input type="text" class="form-control form-control-user" name="kd_transaksi_spp" value="<?= $data_transaksi_spp_bk['kd_transaksi_spp']; ?>" readonly>
            </div>
            <div class="form-group ">
               <label>Nama</label>
            ...
            <input type="text" class="form-control form-control-user" name="biaya" value="Rp. <?= number_format($data_jenis_spp_bkj['biaya'], 0, ',', '.');?>" readonly> 
            </div>

            <div class="form-group">
                <label>Bulan</label>
             <input type="text" class="form-control form-control-user" name="bulan" value=" <?= $data_transaksi_spp_bk['bulan'];?>" readonly> 

            </div>
             <div class="form-group">
               <label>Metode Pembayaran</label>
                <input type="text" class="form-control form-control-user" name="metode_pembayaran" value="<?= $data_transaksi_spp_bk['metode_pembayaran']; ?>" readonly> 
            </div>
            <div class="form-group">
               <label>Nama Bank</label>
               <input type="text" class="form-control form-control-user" name="nama_bank" value=" <?= $data_transaksi_spp_bk['nama_bank'];?>" readonly> 
            </div>

            <div class="form-group">
               <label>Pemilik Rekening</label>
               <input type="text" class="form-control form-control-user" name="pemilik_rekening" value="<?= $data_transaksi_spp_bk['pemilik_rekening']; ?>" readonly> 
            </div>

            <div class="form-group">
               <label>No Rekening</label>
                <input type="text" class="form-control form-control-user" name="no_rekening" value="<?= $data_transaksi_spp_bk['no_rekening']; ?>" readonly> 
            </div>
            <div class="form-group">
               <label>File Transfer</label>
                <input type="text" class="form-control form-control-user" name="file_transfer" value="<?= $data_transaksi_spp_bk['file_transfer']; ?>" readonly> 
            </div>
             <div class="form-group">
            <label>Status</label>
            <select name="status" class="form-control form-control-user" >
                        <?php $status = array('diterima','diproses');?>
                         ...
                         <?php if ($status[$no] == $data_transaksi_spp_bk['status']) {echo "<option value='".$status[$no] ."' selected>".$status[$no]."</option>"; ?>
