      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-light bg-light ">
           ...
           <section>
            <a href="<?= base_url('admin/tambah_data_user'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-user-plus fa-sm text-white-50"></i> Tambah Data User</a>
            </section>
              ...
              <thead>
                ...
                <?php $no=0; foreach ($user as $du) { ?>
                  <tr>
                    ...
                    <td ><?= $du['level']; ?></td>
                    <td >
                        <a href="<?= base_url(); ?>admin/edit_user/<?= $du['kd_user']; ?>" class="btn btn-primary btn-circle btn-sm"><i class="fas fa-user-edit"></i></a>
                        <a href="<?= base_url(); ?>admin/hapus_data_user/<?= $du['kd_user']; ?>" class="btn btn-danger btn-circle btn-sm"><i class="fas fa-trash-alt"></i></a> 
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
