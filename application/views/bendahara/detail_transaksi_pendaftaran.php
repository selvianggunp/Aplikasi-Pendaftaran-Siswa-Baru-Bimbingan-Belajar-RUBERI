                ...
                <div class="card">
                  ...
                  <div class="card-body"> 
                   <div class="row">
                     ...
                     <div class="col-4">
                       : <?= $detail_pendaftaran['kd_transaksi_pendaftaran'] ?>
                     </div>
                   </div>
                    <hr>
                    <div class="row">
                     ...
                     <div class="col-4">
                       : <?= $detail_pendaftaran['kd_jenis_pendaftaran'] ?>
                     </div>
                   </div>
                   <hr>
                   <div class="row">
                   ...
                   <hr>
                    <div class="row">
                     ...
                     <div class="col-4">
                       : <?= $detail_pendaftaran['nama_lengkap'] ?>
                     </div>
                   </div>
                   <hr>
                   <div class="row">
                     ...
                     <div class="col-4">
                       : <?php $tgl = date_create($detail_pendaftaran['tgl_bayar']); echo date_format($tgl, 'd-m-Y'); ?>
                     </div>
                   </div>
                   <hr>
                     <div class="row">
                     ...
                     <div class="col-4">
                       : Rp. <?= number_format($detail_pendaftaran['biaya'], 0, ',', '.'); ?>
                     </div>
                   </div>
                   <hr>
                    <div class="row">
                     ...
                     <div class="col-4">
                      : <?= $detail_pendaftaran['metode_pembayaran'] ?>
                     </div>
                   </div>
                   <hr>
                   <div class="row">
                   ...
                   <div class="row">
                     ...
                     <div class="col-4">
                     : <?= $detail_pendaftaran['pemilik_rekening'] ?>
                     </div>
                   </div>
                   <hr>
                   <div class="row">
                     ...
                     <div class="col-4">
                     : <?= $detail_pendaftaran['no_rekening'] ?>
                     </div>
                   </div>
                   <hr>
                   <div class="row">
                     ...
                     <div class="col-4">
                     : <?= $detail_pendaftaran['file_transfer'] ?>
                     </div>
                   </div>
                   <hr>
                   <div class="row">
                     ...
                     <div class="col-4">
                     : <?= $detail_pendaftaran['status'] ?>
                     </div>
                   </div>
                   <hr>
                    <a class="btn btn-primary" href="<?= base_url('bendahara/data_transaksi_pendaftaran'); ?>"> <i class="fas fa-caret-left"></i>  Kembali</a>
