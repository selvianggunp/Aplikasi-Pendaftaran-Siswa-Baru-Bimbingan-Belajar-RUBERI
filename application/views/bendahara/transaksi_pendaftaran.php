        ...
        <div class="card-body">
         ...
         <form action="" method="POST">
          ...
          <div class="form-group"> 
            ...
            <input type="text" class="form-control form-control-user" name="kd_transaksi_pendaftaran" value="<?= $data_transaksi_pendaftaran_bk['kd_transaksi_pendaftaran'];?>" readonly>
          </div>
          <div class="form-group">
            <label>Nama</label>
            <input type="text" class="form-control form-control-user" name="nama" value="<?= $data_siswa_bku['nama_lengkap']; ?>" readonly> 
          </div>
           <div class="form-group">
            <label for="kd_jenis_daftar">Jumlah yang harus di bayar</label>
            <input type="text" class="form-control form-control-user" name="biaya" id="kd_jenis_daftar" value="Rp. <?= number_format($data_jenis_pendaftaran_bkj['biaya'], 0, ',', '.');?> " readonly> 
          </div>
          <div class="form-group">
            <label>Metode Pembayaran</label>
            <input type="text" class="form-control form-control-user" name="metode_pembayaran" value="<?= $data_transaksi_pendaftaran_bk['metode_pembayaran']; ?>" required readonly> 
          </div>
          <div class="form-group">
            <label>Nama Bank</label>
            <input type="text" class="form-control form-control-user" name="nama_bank" value="<?= $data_transaksi_pendaftaran_bk['nama_bank']; ?>" required readonly> 
          </div>
          <div class="form-group">
            <label>Pemilik Rekening</label>
            <input type="text" class="form-control form-control-user" name="pemilik_rekening" value="<?= $data_transaksi_pendaftaran_bk['pemilik_rekening']; ?>" required readonly> 
          </div>
           <div class="form-group">
            <label>No Rekening</label>
            <input type="text" class="form-control form-control-user" name="no_rekening" value="<?= $data_transaksi_pendaftaran_bk['no_rekening']; ?>" required readonly> 
          </div>
           <div class="form-group">
            <label>File Transfer</label>
            <input type="text" class="form-control form-control-user" name="file_transfer" value="<?= $data_transaksi_pendaftaran_bk['file_transfer']; ?>" readonly readonly> 
          </div>
          <div class="form-group">
            <label>Status</label>
            <select name="status" class="form-control form-control-user" >
                        <?php $status = array('diterima','diproses');?>
                         <?php  for ($no=0; $no<2; $no++) { ?>
                         <?php if ($status[$no] == $data_transaksi_pendaftaran_bk['status']) {echo "<option value='".$status[$no] ."' selected>".$status[$no]."</option>"; ?>
                         <?php }else { echo "<option value=".$status[$no].">".$status[$no]."</option>";} ?>
                        <?php  } ?>  
            </select>
          </div>
