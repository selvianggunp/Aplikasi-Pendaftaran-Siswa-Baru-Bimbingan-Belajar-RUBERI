                ...
                <div class="card">
                  ...
                  <div class="card-body"> 
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="kd_user" name="kd_user" value="<?= $akun['kd_user']; ?>" readonly hidden>
                    </div>
                     <div class="form-group">
                      <div class="text-center"><img  width="100" src="<?= base_url('assets/foto_user/') . $akun['photo'];  ?> "></div><br>
                      <label for="username">Upload photo akun </label>
                      <input type="file" name="photo" id="photo"   class="form-control form-control-user" value="<?= $akun['photo']; ?>"> 
                    </div>
                    <div class="form-group">
                      <label for="username">Username</label>
                      <input type="text" class="form-control form-control-user" name="username" value="<?= $akun['username']; ?>" required>
                    </div>
                    <div class="form-group">
                      <label for="email">Email</label>
                      <input type="text" class="form-control form-control-user" id="email" name="email" value="<?= $akun['email']; ?>" required>
                    </div>
