        ...
        <div class="container-fluid">
         <?= $this->session->flashdata('message'); ?>
          ...
          <nav class="navbar navbar-light bg-light" >
           ...
           <section>
              <a href="<?= base_url('bendahara/tambah_dtspp_pks'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data Transaksi SPP</a>
            ...
            <thead>
             <tr>
              ...
              <th width="20px" >Kode <br>Transaksi SPP</th>
          ...
          <?php $no=0; foreach ($data_transaksi_SPP as $dts) { ?>
            <tr>
                ...
                <td><?= $dts['status']; ?></td>
                <td>
                   <a href="<?= base_url();?>bendahara/transaksi_SPP/<?=  $dts['kd_transaksi_spp']; ?>" class="btn btn-primary btn-circle btn-sm "><i class="fas fa-edit"></i></a> 
                   <a href="<?= base_url(); ?>bendahara/detail_transaksi_spp/<?= $dts['kd_transaksi_spp']; ?>" class="btn btn-info btn-circle btn-sm"><i class="fas fa-align-justify"></i></a> 
                
                  <a target="blank" href="<?= base_url(); ?>cetak/kwitansi_tspp/<?= $dts['kd_transaksi_spp']; ?>" class="btn btn-warning btn-circle btn-sm"><i class="fas fa-receipt"></i></a> 
                </td>
            </tr>
            <?php } ?>
          </tbody>
