        ...
        <div class="card-body">
         ...
         <form action="" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user" name="biaya" value="Rp. <?= $data_jenis_spp_bkj['biaya']; ?>" readonly> 
          </div>
           <div class="form-group">
            <label>Bulan</label>
            <select name="bulan" class="form-control form-control-user" id="bulan">
                        <?php $bulan = array('Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember');  ?>
                         ...
                         <?php if ($bulan[$no] == $data_transaksi_spp_bk['bulan']) {echo "<option value='".$bulan[$no] ."' selected>".$bulan[$no]."</option>"; ?>
                         <?php }else { echo "<option value=".$bulan[$no].">".$bulan[$no]."</option>";} ?>
                         <?php  } ?>  
                      </select>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user" name="nama_bank" value="<?= $data_transaksi_spp_bk['nama_bank']; ?>" > 
          </div>
           <div class="form-group">
            <label>Pemilik Rekening</label>
            <input type="text" class="form-control form-control-user" name="pemilik_rekening" value="<?= $data_transaksi_spp_bk['pemilik_rekening']; ?>" > 
          </div>
           <div class="form-group">
            <label>No Rekening</label>
            <input type="text" class="form-control form-control-user" name="no_rekening" value="<?= $data_transaksi_spp_bk['no_rekening']; ?>" > 
          </div>
           <div class="form-group">
           ...
           <div class="form-group">
            ...
            <select name="ket" class="form-control form-control-user">
                    <?php $ket= array('diproses','diterima');?>
                         <?php  for ($no=0; $no<2; $no++) { ?>
                         <?php if ($ket[$no] == $data_transaksi_spp_bk['status']) {echo "<option value='".$ket[$no] ."' selected>".$ket[$no]."</option>"; ?>
                         <?php }else { echo "<option value=".$ket[$no].">".$ket[$no]."</option>";} ?>
                    <?php  } ?> 
            </select> 
          </div>
