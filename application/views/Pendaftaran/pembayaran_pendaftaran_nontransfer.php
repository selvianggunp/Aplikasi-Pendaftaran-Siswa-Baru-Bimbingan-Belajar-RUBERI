              ...
              <div class="col-md">
                <div class="card">
                  <div class="card-header" align="center">
                   Pembayaran Pendaftaran Non Transfer
                  </div>
                  <div class="card-body">
                  ...
                  <!----------------------------------- PEMBAYARAN ------------------------------------>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-user" name="kd_transaksi_pendaftaran" value="<?= $newkode_trd; ?>" readonly>
                    </div>
                     <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="kd_user" value="<?= $kd_user; ?>" readonly hidden> 
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="kd_jenis_pendaftaran" value="<?= $data['kd_jenis_pendaftaran']; ?>" readonly hidden>
                    </div>
                    <div class="form-group">
                      <label>Nama</label>
                      <input type="text" class="form-control form-control-user" name="nama_lengkap" value="<?= $data['nama_lengkap']; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label>Jumlah yang harus di bayar</label>
                      <input type="text" class="form-control form-control-user" name="biaya" value="Rp. <?= number_format($data['biaya'], 0, ',', '.'); ?>" readonly> 
                    </div>
                    
                     <div class="card-header" align="center">
                        Instruksi Pembayaran
                     </div>
                    <p>1. Sampaikan kepada bagian administrasi untuk melakukan pembayaran pendaftaran non transfer.</p>
                    <p>2. Tunjukkan kode transaksi pendaftaran dan lakukan pembayaran pendaftaran sebesar Rp. <?= number_format($data['biaya'], 0, ',', '.'); ?>.</p>
                    <p>3. Setelah transaksi selesai, kamu akan menerima kwitansi transaksi pendaftaran.</p>
                    <p>4. Selesai.</p>
