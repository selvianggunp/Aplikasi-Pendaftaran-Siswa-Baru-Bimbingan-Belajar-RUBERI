            ...
            <div class="container">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary text-center">Metode Pembayaran Pendaftaran</h6>
                </div><br>
                <div class="col">
                  <div class="alert alert-info" role="alert">
                  Pembayaran pendaftaran sebesar Rp. <?= number_format($data_jp['biaya'], 0, ',', '.'); ?>, silahkan pilih metode pembayaran.
                </div>
                </div>
                
                <div class="card-body">
                
                 <a href="<?= base_url('Pembayaran_pendaftaran/transfer'); ?>" class="btn btn-outline-primary">Transfer</a>
                 <a href="<?= base_url('Pembayaran_pendaftaran/nontransfer'); ?>" class="btn btn-outline-primary">Non Transfer</a>
