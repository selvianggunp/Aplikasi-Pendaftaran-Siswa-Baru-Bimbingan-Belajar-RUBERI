          ...
          <!-- Nav Item - User Information -->
            <li class="nav-item dropdown " >
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?= base_url('usehome/cpb'); ?>">
                  <i class="fas fa-align-justify fa-sm fa-fw mr-2 text-gray-400"></i>
                  Cara Pendaftaran Bimbel
                </a>
                <a class="dropdown-item" href="<?= base_url('usehome/cpspph'); ?>">
                 <i class="fas fa-align-justify fa-sm fa-fw mr-2 text-gray-400"></i>
                  Cara Pembayaran SPP
                </a>
                 <a class="dropdown-item" href="<?= base_url('usehome/kontak_kami'); ?>">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ul class="list-group col-md">
               <li class="list-group-item">
                 <h2>Cara Pendaftaran Bimbel</h2><br>
                1. Buat Akun RUBERI <br>
                2. jika sudah membuat akun RUBERI selanjutnya melakukan Login dengan akun yang sebelumnya sudah di buat<br>
                3. Klik pendaftaran<br>
                4. Pilih jenjang sesuai yang ingin di ambil<br>
                5. Mengisi formulir pendaftaran<br>
                6. Jika ingin melakukan pembayaran pendaftaran secara transfer maka pilih BAYAR TRANSFER, kemudian mengisi Form Pembayaran Transfer<br>
                7. kemudian klik BAYAR DAN DAFTAR.<br>
                8. jika ingin melakukan pembayaran pendaftaran secara non transfer maka pilih BAYAR NON TRANSFER, kemudian klik BAYAR DAN DAFTAR.<br>
                9. lakukan pembayaran pendaftaran dengan datang ke administrasi.<br>
                10. selesai.
               </li>
            </ul>
